...
public class ShenyuHttpClientHttpClientMetricsRecorder implements HttpClientMetricsRecorder {
    ...
    public void recordDataReceivedTime(SocketAddress remoteAddress, String uri, String method, String status, Duration time) {
        log.info("接收响应,address={},method={},uri={},status={},duration={}ms", remoteAddress, method, uri, status, time.toMillis());
    }

    @Override
    public void recordDataSentTime(SocketAddress remoteAddress, String uri, String method, Duration time) {
        log.info("发送请求,address={},method={},uri={},duration={}ms", remoteAddress, method, uri, time.toMillis());
    }

    @Override
    public void recordResponseTime(SocketAddress remoteAddress, String uri, String method, String status, Duration time) {
        // TODO 后端服务处理及网络往返耗时
        log.info("后端耗时,address={},method={},uri={},status={},duration={}ms", remoteAddress, method, uri, status, time.toMillis());
    }
